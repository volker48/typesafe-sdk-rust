...
The SDK currently provides async System One and model listing, including custom
Serde response models and raw question extensions. Blocking calls and SDK logging
are not implemented. Counts and score-map keys use `i64`; probabilities use `f64`.
