...
The three suites contain 175 shared scenarios (40 base, 68 foundation, 67 model
listing). This is characterized behavior, not exhaustive Python SDK parity.
...
Custom response models, raw question extensions, blocking use, SDK logging,
custom transport, arbitrary retry predicates, broader date/header parsing,
