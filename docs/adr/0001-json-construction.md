...
typed Rust construction, and plan a fallible convenience facade with precise local
...
[implementation gates](../plans/request-ergonomics.md); proposed methods are not
